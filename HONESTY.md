...
- **The UI is fully bilingual (English + Traditional Chinese)** via a cookie-based switcher. Stored clinical text (alert reasons, rule evidence, summaries, PDF/FHIR exports) deliberately stays English — HK clinical-documentation convention and audit stability. The zh-HK catalog is machine-drafted and flagged for native review before clinical deployment.
