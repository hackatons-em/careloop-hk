  ...
  return (
    <div className="cl-rise rounded-2xl border border-border bg-card p-5">
      ...
      <p className="mt-2 text-sm text-muted-foreground">
        This deployment runs in demo mode: the clinical clock is frozen to the demo week and the
        dataset is synthetic. Reset restores the canonical five-patient scenario.
      </p>
      <div className="mt-4">
